...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 1, 1, 'vertical', true, 3000);
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 2, 1, 'horizontal', true, 3000, '.main-prev-btn', '.main-next-btn');
...
var forms = function forms() {
  ...
  Array.from(inputs).filter(function (item) {
    return item.getAttribute('name') === 'upload';
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api);
      postData(api, formData).then(function () {
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var scrollSize = calcScroll();
    var gift = document.querySelector('.fixed-gift');
    var currentPositionGift = getComputedStyle(gift).right;
    triggers.forEach(function (item) {
      item.addEventListener('click', function () {
        modal.style.display = 'block';
        document.body.style.overflow = 'hidden';
        document.body.style.marginRight = "".concat(scrollSize, "px");
        modal.setAttribute('data-active', true);
        gift.style.right = "".concat((parseInt(currentPositionGift) + scrollSize) / 10, "rem");
    ...
    close.addEventListener('click', function () {
      ...
      gift.style.right = "".concat(parseInt(currentPositionGift) / 10, "rem");
    });
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      var activeModal = document.querySelector('[data-active]');
...
var sliders = function sliders(slides, start, step, dir) {
  var auto = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var time = arguments.length > 5 ? arguments[5] : undefined;
  var prev = arguments.length > 6 ? arguments[6] : undefined;
  var next = arguments.length > 7 ? arguments[7] : undefined;
